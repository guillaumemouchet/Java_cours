...
public class AddVector implements Runnable
	...
	public void run()
		...
		switch(this.typeExecution)
			...
			default:
				{
				Assertions.fail("[AddVector]:run(): " + this.typeExecution + " pas codé");
				break;
				}
			}
		}
	...
	private void runnable()
		{
		Runnable runnable1 = createRunnable(this.intervale1);
		Runnable runnable2 = createRunnable(this.intervale2);

		runnable1.run();
		runnable2.run();
		}

	private Runnable createRunnable(Intervale intervale)
		{
		return new Runnable()
			{
			@Override
